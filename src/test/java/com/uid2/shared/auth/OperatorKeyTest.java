...
public class OperatorKeyTest {
    ...
    public void verifyRolesPropIsWrittenInAlphabeticalOrder() throws JsonProcessingException {
        final String expectJson = "{" +
                ...
                "}";
        OperatorKey k = new OperatorKey("test-admin-key", "test-keyHash", "admin@uid2.com", "admin@uid2.com", "protocol1", 1617149276, false, 1, new HashSet<>(Arrays.asList(Role.OPTOUT, Role.OPERATOR)));
    ...
    public void verifyConstructorStartsWithPrivateOperator() {
        OperatorKey k1 = new OperatorKey("key1", "test-keyHash1", "name1", "contact1", "protocol1", 1, true);
        Assert.assertEquals(OperatorType.PRIVATE, k1.getOperatorType());
        OperatorKey k2 = new OperatorKey("key2", "test-keyHash2", "name2", "contact2", "protocol2", 2, true, 2);
        Assert.assertEquals(OperatorType.PRIVATE, k2.getOperatorType());
        OperatorKey k3 = new OperatorKey("key3", "test-keyHash3", "name3", "contact3", "protocol3", 3, true, 3,  null);
        Assert.assertEquals(OperatorType.PRIVATE, k3.getOperatorType());
        OperatorKey k4 = new OperatorKey("key4", "test-keyHash4", "name4", "contact4", "protocol4", 4, true, 4,  null, OperatorType.PUBLIC);
        Assert.assertEquals(OperatorType.PUBLIC, k4.getOperatorType());
        OperatorKey k5 = new OperatorKey("key5", "test-keyHash5", "name5", "contact5", "protocol5", 5, true, 5,  null, OperatorType.PRIVATE);
